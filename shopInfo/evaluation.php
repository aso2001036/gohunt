                ...
                $Appearance_AVG = $atmosphere_AVG = $taste_AVG = '';
                   ...
                   /*$pdo = new PDO(
                    ...
                    <div class="evaluation">
                        <input id="easy_enter5" type="radio" name="appearance" value="1" required>
                        <label for="easy_enter5">★</label>
                        <input id="easy_enter4" type="radio" name="appearance" value="2" required>
                        <label for="easy_enter4">★</label>
                        <input id="easy_enter3" type="radio" name="appearance" value="3" required>
                        <label for="easy_enter3">★</label>
                        <input id="easy_enter2" type="radio" name="appearance" value="4" required>
                        <label for="easy_enter2">★</label>
                        <input id="easy_enter1" type="radio" name="appearance" value="5" required>
                        <label for="easy_enter1">★</label>
                    </div>
                    <a class="evaluation_text">味</a><br>
                    <div class="evaluation">
                        <input id="taste5" type="radio" name="taste" value="1" required>
                        <label for="taste5">★</label>
                        <input id="taste4" type="radio" name="taste" value="2" required>
                        <label for="taste4">★</label>
                        <input id="taste3" type="radio" name="taste" value="3" required>
                        <label for="taste3">★</label>
                        <input id="taste2" type="radio" name="taste" value="4" required>
                        <label for="taste2">★</label>
                        <input id="taste1" type="radio" name="taste" value="5" required>
                        <label for="taste1">★</label>
                    </div>
                    <a class="evaluation_text">雰囲気</a><br>
                    <div class="evaluation">
                        <input id="ambience5" type="radio" name="atmosphere" value="1" required>
                        <label for="ambience5">★</label>
                        <input id="ambience4" type="radio" name="atmosphere" value="2" required>
                        <label for="ambience4">★</label>
                        <input id="ambience3" type="radio" name="atmosphere" value="3" required>
                        <label for="ambience3">★</label>
                        <input id="ambience2" type="radio" name="atmosphere" value="4" required>
                        <label for="ambience2">★</label>
                        <input id="ambience1" type="radio" name="atmosphere" value="5" required>
